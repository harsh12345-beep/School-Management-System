...
new.title("Updatation in students")
id = IntVar()
name = StringVar()
number =StringVar()
Gender = StringVar()
...
def newst():
    ...
    db.commit()
    db.close()
heading = Label(new, text="Updatation In Table Using RollNo", border=10,  bg="black", fg="white", font=("times new roman", 30, "bold"))
heading.pack(fill=X)
a= Label(text="RollNo",font="arial 15",bd=10,bg="black",fg="white")
a.place(x=50,y=130)
le = Entry( width=10,textvariable=id, font="arial 15")
le.place(x=200,y=130)
b = Label(new, text="FirstName", font="arial 15",bd=10,bg="black",fg="white")
b.place(x=50,y=200)
le = Entry( width=10,textvariable=name, font="arial 15")
le.place(x=200,y=200)
c = Label(new, text="LastName", font="arial 15",bd=10,bg="black",fg="white")
c.place(x=50,y=270)
...
e = Label(new, text="Class", font="arial 15",bd=10,bg="black",fg="white")
e.place(x=50,y=410)
le = Entry( width=10,textvariable=experience, font="arial 15")
le.place(x=200,y=410)
e = Label(new, text="Fathername", font="arial 15",bd=10,bg="black",fg="white")
e.place(x=50,y=480)
